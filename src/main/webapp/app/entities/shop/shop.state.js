    ...
    function stateConfig($stateProvider) {
        ...
        .state('shop', {
            ...
            data: {
                ...
                pageTitle: 'productManagementApp.shop.home.title'
            },
            views: {
                'content@': {
            ...
            resolve: {
                translatePartialLoader: ['$translate', '$translatePartialLoader', function ($translate, $translatePartialLoader) {
                    ...
                    $translatePartialLoader.addPart('shopActivityType');
                    $translatePartialLoader.addPart('shopStatus');
        ...
        .state('shop-detail', {
            ...
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'productManagementApp.shop.detail.title'
            },
            views: {
                'content@': {
