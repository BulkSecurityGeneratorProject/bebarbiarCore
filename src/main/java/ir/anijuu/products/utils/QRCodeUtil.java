...
public class QRCodeUtil {
	...
	public static String getBarcode(User user) {
        String myCodeText = user.getLogin();
        int size = 250;
        String fileType = "png";
        try {
            File myFile  = File.createTempFile("temp-file-name", ".png");
            ...
            String result =  Base64.getEncoder().encodeToString(Files.readAllBytes(myFile.toPath()));
            return result;
