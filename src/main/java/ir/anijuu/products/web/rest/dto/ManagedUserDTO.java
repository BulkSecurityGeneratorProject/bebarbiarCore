...
public class ManagedUserDTO extends UserDTO {
    ...
    public ManagedUserDTO(Long id, String login, String password, String firstName, String lastName,
                          String email, boolean activated, String langKey, Set<String> authorities ,UserType userType, ZonedDateTime createdDate, String lastModifiedBy, ZonedDateTime lastModifiedDate ) {
