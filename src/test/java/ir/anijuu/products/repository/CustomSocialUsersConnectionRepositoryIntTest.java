...
import ir.anijuu.products.ProductManagementApp;
import ir.anijuu.products.domain.SocialUserConnection;
...
@SpringApplicationConfiguration(classes = ProductManagementApp.class)
@WebAppConfiguration
@IntegrationTest
@Transactional
